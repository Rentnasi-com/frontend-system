    ...
    return (
        <>
            <div className="p-4 flex justify-between mx-4">
                <div>
                    <h1 className="text-xl font-bold text-gray-700">Landlords Listing</h1>
                    <p className="text-sm text-gray-500">Real-time information and activities of your landlords.</p>
                </div>
            </div>
                                        ...
                                        <td className="px-2 py-4">
                                            ...
                                            <div className="flex space-x-10">
                                                ...
                                                <div className="mt-1">
                                                    ...
                                                    <p className="font-semibold text-black">
                                                        {landlord.id_or_passport_number}
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
