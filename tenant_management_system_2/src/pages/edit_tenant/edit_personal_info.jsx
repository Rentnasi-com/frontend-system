  ...
  const fetchTenantDetails = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        setValue("phone", response.data.result.phone)
        setValue("id_or_passport_number", response.data.result.id_or_passport_number)
        setValue("next_of_kin_name", response.data.result.next_of_kin_name)
            ...
            <div className="flex justify-between space-x-4">
              <div className="w-full">
                <label
                  ...
                  className="block my-2 text-sm font-medium text-gray-900"
                >
                  Phone Number <span className="text-red-600 text-xs">*Not Editable</span>
                </label>
                <input
                  readOnly="true"
                  aria-label="phone"
              ...
              <div className="w-full">
                <label
                  ...
                  className="block my-2 text-sm font-medium text-gray-900"
                >
                  ID/Passport Number <span className="text-red-600 text-xs">*Not Editable</span>
                </label>
                <input
                  readOnly="true"
            ...
            <div className="flex justify-between">
              <div className="h-full w-full">
                ...
                <div className="flex justify-center items-center mt-4">
                  <img className="h-32 w-auto" src={documentUrl} alt="document Url" />
                </div>
              </div>
            </div>
