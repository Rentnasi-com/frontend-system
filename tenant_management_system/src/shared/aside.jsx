      ...
      <aside className="w-64 border-r border-gray-200 fixed z-20 h-full top-0 left-0 pt-10 flex lg:flex flex-shrink-0 flex-col transition-width duration-75" aria-label="Sidebar">
        <div className="h-full py-4 overflow-y-auto">
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to={`${propertyUrl}?sessionId=${sessionId}&userId=${userId}`} className="flex items-center p-2 text-gray-700 rounded-lg hover:bg-red-100 group">
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Property Management</span>
              </Link>
            </li>
