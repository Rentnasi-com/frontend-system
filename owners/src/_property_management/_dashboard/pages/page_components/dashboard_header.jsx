...
const DashboardHeader = ({ title, description, link, name, hideSelect, selectUnit, hideLink, properties, units, onSelectChange, onUnitSelectChange }) => {
    ...
    <>
      ...
      <div className="p-4 md:flex space-y-4 justify-between">
        ...
        <div className="flex">
          ...
          {hideSelect && (
            <div className="">
              <select onChange={onSelectChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-32 px-2 py-2.5">
          ...
          {selectUnit && (
            <div className="">
              <select onChange={onUnitSelectChange} className="ml-3 bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-32 px-2 py-2.5">
