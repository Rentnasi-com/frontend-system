                    ...
                    <div className="mt-4 bg-white p-4 rounded">
                        ...
                        <div className="mt-4 flex items-center border-t pt-4">
                            <button className="mr-4">
                                <img src="../../../../../assets/icons/png/attach.png" alt="Attach" width={20} />
                            </button>
                            <input
                                type="text"
                            ...
                            <button className="ml-4 bg-red-600 text-white p-2 rounded-full">
                                <img src="../../../../../assets/icons/png/send.png" alt="Send" width={20} />
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div className="border-l bg-white">
                    ...
                    <div className="flex justify-center items-center space-x-3 mb-4 p-2">
                        <button className="bg-white border-red-400 border p-2 rounded-md flex items-center text-sm">
                            <img src="../../../../../assets/icons/png/call.png" alt="Call" className="w-4 h-4 mr-2" />
                            Call
                        </button>
                        <button className="bg-white border-red-400 border p-2 rounded-md flex items-center text-sm">
                            <img src="../../../../../assets/icons/png/email.png" alt="Call" className="w-4 h-4 mr-2" />
                            Call
                        </button>
                    </div>
...
export default MaintenanceChatRoom