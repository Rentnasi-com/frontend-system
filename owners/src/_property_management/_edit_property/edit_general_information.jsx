...
const EditGeneralInformation = () => {
  ...
  const schema = z.object({
    property_name: z.string().min(4, { message: "Property name must be at least 4 characters long" }),
    location_name: z.string().min(4, { message: "Location must be at least 4 characters long" }),
  });
