...
const ManageImages = () => {
  ...
  const handleSubmitOtherImages = async (unitTypeId) => {
    ...
    setUnitLoading((prevLoading) => ({ ...prevLoading, [unitTypeId]: true }));
    ...
    try {
      ...
      if (response.status !== 200) {
        ...
        setUnitLoading((prevLoading) => ({ ...prevLoading, [unitTypeId]: false }));
        return;
      }
            ...
            <div key={unitType.unit_type_id}>
              <div className="bg-white rounded-xl shadow p-4 h-full">
                ...
                <button
                  ...
                  disabled={unitLoading[unitType.unit_type_id]}
                >
                  {unitLoading[unitType.unit_type_id] ? "Uploading..." : `Upload ${unitType.name} Images`}
                </button>
              </div>
            </div>
          ))}
