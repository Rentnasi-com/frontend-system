                  ...
                  <div className="flex justify-between space-x-4">
                    <div className="w-full">
                      ...
                      <input
                        ...
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-red-500 focus:border-red-500 block w-full p-2.5"
                      />
                      {errors.initial_meter_reading && (
                        <p className="text-xs text-red-500">
                          {errors.initial_meter_reading.message}
                        </p>
                      )}
                    </div>
                  </div>
            ...
            <div className="flex justify-between space-x-4">
              <div className="w-full">
                ...
                <select
                  ...
                  value={watch("rent_due_date") || ""}
                >
                  <option value="">Select rent due date</option>
                  {Array.from({ length: 31 }, (_, i) => i + 1).map(day => (
                    <option key={day} value={day.toString()} selected={watch("rent_due_date") === day.toString()}>
                      {day}
                    </option>
                  ))}
                </select>
              ...
              <div className="w-full">
                ...
                <select
                  ...
                  value={watch("due_rent_reminder_date") || ""}
                >
                  <option value="">Select due rent reminder date</option>
                  {Array.from({ length: 31 }, (_, i) => i + 1).map(day => (
                    <option key={day} value={day.toString()} selected={watch("due_rent_reminder_date") === day.toString()}>
                      {day}
                    </option>
                  ))}
                </select>
            ...
            <div className="flex justify-between space-x-4">
              <div className="w-full">
                ...
                <select
                  ...
                  value={watch("due_rent_fine_start_date") || ""}
                >
                  <option value="">Select due rent fine start date</option>
                  {Array.from({ length: 31 }, (_, i) => i + 1).map(day => (
                    <option key={day} value={day.toString()} selected={watch("due_rent_fine_start_date") === day.toString()}>
                      {day}
                    </option>
                  ))}
                </select>
              ...
              <div className="w-full">
                ...
                {errors.mode_for_late_payment && (
                  <p className="text-xs text-red-500">
                    {errors.mode_for_late_payment.message}
                  </p>
                )}
              </div>
            </div>
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex">
                    <div className="flex items-center h-5">
                      <input
                        {...register("amount_criteria")}
                        aria-label="current_full_month_rent"
                        type="radio"
                        value="current_full_month_rent"
                  ...
                  <label className="flex">
                    <div className="flex items-center h-5">
                      <input
                        {...register("amount_criteria")}
                        type="radio"
                        value="current_full_month_rent_balance"
                        className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2"
                      />
                    </div>
                    <div className="ms-2 text-sm">
                  ...
                  <div className="flex">
                    <div className="flex items-center h-5">
                      <input
                        {...register("amount_criteria")}
                        type="radio"
                        value="total_cumulative_balances_inclusive_of_previous_month"
                        className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2"
                      />
                    </div>
                    <div className="ms-2 text-sm">
