                ...
                <div className="space-y-4">
                    ...
                    <div className="border rounded bg-white p-4">
                        ...
                        <div className="grid grid-cols-2 p-2 rounded mt-6 divide-x ">
                            <div>
                                <h6 className="text-green-500 text-xl font-semibold">Ksh {incomeSummary?.paid_rent?.toLocaleString()}</h6>
                                <h6 className="text-green-500 text-xs">Paid rent</h6>
                            </div>
                            <div className="text-center">
                                <h6 className="text-red-500 text-xl font-semibold">Ksh {incomeSummary?.unpaid_rent?.toLocaleString()}</h6>
