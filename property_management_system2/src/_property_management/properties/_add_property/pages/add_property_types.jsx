...
const Property_types = () => {
  ...
  const [propertyTypes, setPropertyTypes] = useState([]); // List of all property types
  const [selectedType, setSelectedType] = useState(null); // User's previously selected type
  ...
  const goToPrevious = () => {
    navigate(`/add-property/amenities?property_id=${propertyId}`);
  };
