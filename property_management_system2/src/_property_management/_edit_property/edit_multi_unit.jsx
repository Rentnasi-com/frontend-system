...
import FloorDetails from "../_add_property/pages/floors/floorDetails";
import Units from "../_add_property/pages/floors/units";
  ...
  const handleFinalSubmit = async () => {
    try {
      ...
      if (response.data.status) {
        ...
        navigate(`/edit-property/manage-images?property_id=${propertyUrlId}`);
      } else {
