    ...
    const onSubmit = async (values) => {
        ...
        try {
            ...
            if (!conversionResponse.data.success) {
                toast.error("Error while upload your id or passport!" || conversionResponse.data.message)
            }
            const document_url = conversionResponse.data.urls;
            const dataToSend = {
                ...values,
                document_url,
            }
            ...
            const response = await axios.post(
                "https://pm.api.rentnasi.com/api/v1/manage-landlord/create-landlord/basic-info", dataToSend,
                {
                    headers: {
            ...
            if (response.data.success) {
                const landlord_id = response.data.result.landlord_id
                localStorage.setItem('landlord_id', landlord_id)
                toast.success(response.data.message)
                navigate("/landlord/add-payment-details")
