                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 py-6">
                    {appsLoading ? (
                        ...
                        Array(4).fill(0).map((_, index) => (
                            <div
                                key={index}
                                className="flex flex-row items-center p-2 rounded shadow-sm border bg-white space-x-4"
                            >
                        ...
                        appsTypes.map((type) => (
                            <a
                                ...
                                target="_blank"
                                key={type.app_id}
                                className="flex flex-row items-center p-2 rounded shadow-sm border bg-white hover:shadow-md hover:-translate-y-1 hover:bg-gray-50 transition-all duration-200 space-x-4"
                            >
                                <img
                                ...
                                />
                                <div className="flex flex-col space-y-1">
                                    <h3 className="text-gray-800 font-medium text-sm truncate">{type.app_name}</h3>
                                    <h3 className="text-gray-600 text-xs truncate">For {type.organization_name}</h3>
                                </div>
                            </a>
                        ))
                    ) : (
