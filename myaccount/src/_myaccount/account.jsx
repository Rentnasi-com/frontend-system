            ...
            <section className="md:mx-20">
                <div className="mt-6">
                    <div className="flex flex-col justify-center items-center space-y-3">
                        <h1 className="text-4xl text-gray-800">Personal info</h1>
                        <p className="text-sm text-gray-500">Info about you and your preferences across Google services.</p>
                    </div>
                </div>
                <div className="flex justify-center items-center space-x-4 mt-2">
                    <div className="">
                        <h2 className="text-2xl text-gray-800">Your profile info in Rentnasi services</h2>
                        <p className="text-sm text-gray-500 mt-3">
                            Personal info and options to manage it. You can make some of this info, like your contact details, visible to others so they can reach you easily. You can also see a summary of your profiles.</p>

                    </div>
                    <div className="">
                        <img className="" src="https://www.gstatic.com/identity/boq/accountsettingsmobile/profile_scene_visible_1080x384_3289b9d30bfeff97d2fb2f9908c6d1bc.png" alt="" />
                    </div>
                </div>
                <div className="flex justify-center mt-2">
                    <div className="rounded-lg border p-4 text-gray-700 bg-white">
                        <h4 className="text-lg">Basic info</h4>
