      ...
      <aside className="hidden md:w-64 border-r border-gray-200 fixed z-20 h-full top-0 left-0 pt-10 md:flex lg:flex flex-shrink-0 flex-col transition-width duration-75" aria-label="Sidebar">
        <div className="h-full py-4 overflow-y-auto">
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/dashboard" className="flex items-center p-2 text-gray-700 rounded-lg bg-red-100 group">
            ...
            <li>
              <Link to="/view-apps" className="flex items-center p-2 text-gray-700 rounded-lg hover:bg-red-100 group">
            ...
            <hr />
            <li className="">
              <Link to="" className="flex items-center p-2 text-gray-700 rounded-lg hover:bg-red-100 group">
            ...
            <li className="">
              ...
              <Dropdown label="" dismissOnClick={false} renderTrigger={() => <div className="flex items-center p-2 text-gray-700 rounded-lg hover:bg-red-100 group">
                <svg className="flex-shrink-0 w-5 h-5 text-red-500 transition duration-75 group-hover:text-red-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
